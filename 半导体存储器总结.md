...
![](https://pic.gaomf.store/%E5%8D%8A%E5%AF%BC%E4%BD%93%E5%AD%98%E5%82%A8%E5%99%A8%E6%80%BB%E7%BB%93.svg)
...
![](https://pic.gaomf.store/Circuit20160225153539.png)
...
![](https://pic.gaomf.store/Circuit20160225153755.png)
...
![](https://pic.gaomf.store/Circuit20160225154524.png)
...
![](https://pic.gaomf.store/CircuitAntiFuse.GIF)
...
![](https://pic.gaomf.store/Circuitfgmos.jpg)

悬浮栅极位于两层二氧化硅绝缘层之间，因此存储于其中的电荷可以得到长久的保持。EPROM、EEPROM及Flash的Memory cell简化结构示意图如下
![](https://pic.gaomf.store/Circuit20160225163857.png)
...
![](https://pic.gaomf.store/Circuit20160225182323.png)
...
其Memory cell简化结构示意图如下
![](https://pic.gaomf.store/Circuit20160225183052.png)
...
![](https://pic.gaomf.store/Circuitflip-flop-register.gif)
...
24Cxx系列的引脚定义如下
![](https://pic.gaomf.store/Circuit24Cxx.png)
![](https://pic.gaomf.store/Circuit20160225202124.png)

24Cxx系列通过标准I2C接口与MCU进行通信。`A0`-`A2`引脚是器件地址输入，可以将多片24Cxx（24C16除外）同时接到I2C总线上以达到扩大容量的目的，不过这个功能一般不使用。`WP`引脚是写保护，一般也不使用，直接接地即可。

两个典型操作的时序图如下：
![](https://pic.gaomf.store/Circuit20160225203151.png-height)
![](https://pic.gaomf.store/Circuit20160225203259.png-height)
...
![](https://pic.gaomf.store/Circuit20160225211221.png)
...
![](https://pic.gaomf.store/Circuit20160225211551.png)

二者的综合性能比较见下图
![](https://pic.gaomf.store/Circuit20160225211819.png)
...
![](https://pic.gaomf.store/Circuit20160225214312.png)
...
![](https://pic.gaomf.store/Circuit20160225222049.png)

一般NAND Flash有以下这些信号线：
![](https://pic.gaomf.store/Circuit20160225223229.png)
...
![](https://pic.gaomf.store/CircuitSDRAM%E6%95%B0%E6%8D%AE%E4%BC%A0%E8%BE%93%E9%80%9F%E7%8E%87.png)

![](https://pic.gaomf.store/Circuitsdram_cpr1.png)
...
![](https://pic.gaomf.store/Circuit20160225194159.png)
